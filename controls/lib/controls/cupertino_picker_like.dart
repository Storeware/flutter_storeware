...
class CupertinoPickerLike extends StatefulWidget {
  final TextStyle style;
  final Color highlighterBorder;
  final Color highlighter;
  final double foregroundScreenOpacityFraction;
  ...
  CupertinoPickerLike({
    ...
    this.foregroundScreenOpacityFraction = _kForegroundScreenOpacityFraction,
  ...
  CupertinoPickerLike.builder({
    ...
    this.useMagnifier = false,
    this.magnification = 1.0,
    this.foregroundScreenOpacityFraction = 0.7,
    this.scrollController,
    this.squeeze = _kSqueeze,
    this.style,
    this.highlighterBorder = _kHighlighterBorder,
  ...
  @override
  State<StatefulWidget> createState() => _CupertinoPickerLikeState();
}

class _CupertinoPickerLikeState extends State<CupertinoPickerLike> {
  ...
  @override
  void didUpdateWidget(CupertinoPickerLike oldWidget) {
  ...
  /// Makes the fade to [CupertinoPickerLike.backgroundColor] edge gradients.
  ...
  Widget _buildMagnifierScreen() {
    final Color foreground = widget.backgroundColor?.withAlpha(
      (widget.backgroundColor.alpha * widget.foregroundScreenOpacityFraction).toInt()
    );
  ...
  Widget build(BuildContext context) {
    highlightColor = widget.highlighter??widget.backgroundColor;
    Widget result = DefaultTextStyle(
      style: widget.style ?? TextStyle(color: Colors.black,fontSize: 18) ,
      child: Stack(
        children: <Widget>[
          Positioned.fill(
