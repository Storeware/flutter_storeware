...
List<List<Color>> _colores=[
  [Color(0xFF03A9F4),Color(0xFFFF6D00),Colors.black12,Colors.blue,Colors.deepOrangeAccent],
  [Color(0xFF66BB6A),Colors.deepOrange[50],Colors.lime[50],Colors.lightGreen[100],Colors.greenAccent[100]],
