    ...
    return Scaffold(
      ...
      body: PdfPreview(
        ...
        onError: (BuildContext context) {
          return Container(child: Text('N√£o h√° dados no documento'));
        },
...
class PdfDataPreview extends StatefulWidget {
  ...
  static tests() {
    return PdfDataPreview(
      reportTitle: 'Movimenta√ß√µes',
      source: [
        for (var i = 1; i < 50; i++) {"codigo": '$i', "nome": "teste$i"},
      ],
      columns: [
        PdfReportColumn(name: 'codigo', label: 'CÛdigo'),
        PdfReportColumn(name: 'nome', label: 'DescriÁ„o'),
      ],
      bands: PdfBands(
